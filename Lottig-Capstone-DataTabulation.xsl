...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="response">
        <tr>
            ...
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='5']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='6']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            ...
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='7b']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='8']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            ...
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='9b']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='10']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            ...
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='13b']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='14']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='15']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
            <td><ul><xsl:for-each select="//answer[@n='2'][contains(., 'Male')]/following-sibling::answer[@n='16']"><li><xsl:text>"</xsl:text><xsl:apply-templates select="."/><xsl:text>"</xsl:text></li></xsl:for-each></ul></td>
        </tr>
    </xsl:template>
</xsl:stylesheet>